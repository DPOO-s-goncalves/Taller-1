...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar Nacionalidad atleta");
	...
	private void ejecutarNacionalidadAtleta()
	{
		...
		String nombreAtleta = input("Por favor ingrese el nombre de una atleta");
		Pais paisAtleta = calculadora.buscarAtletaPais(nombreAtleta);
		{
			System.out.println("\n" + "EL pais al que pertenece al atleta es: " + paisAtleta.darNombre()+ "\n");
		}
